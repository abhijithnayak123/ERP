...
namespace iMANTRA
{
    public partial class frmShow_Out : BaseClass
    {
      ...
      //  string strSearchField = "head_nm";
        ...
        private void frmShow_Out_Load(object sender, EventArgs e)
        {
        ...
        private void frmShow_Out_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void frmShow_Out_Enter(object sender, EventArgs e)
        {
            if (((frm_mainmenu)this.MdiParent).ActiveMdiChild != null)
            {
