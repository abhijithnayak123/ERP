...
namespace iMANTRA
{
    public partial class frmCustomerMast : BaseClass
    {
        ...
        public frmCustomerMast(BL_BASEFIELD objBL)
        {
        ...
        private void frmCustomerMast_Load(object sender, EventArgs e)
        {
            BindControls();
        ...
        private void InsertFieldValueToHashTable()
        {
            ...
            objBASEFILEDS.HTMAIN["AC_NM"] = txtCustNm.Text;
            ...
            objBASEFILEDS.HTMAIN["isdeactive"] = chkcust_active.Checked;
        ...
        {
            txtCustNm.Text = objBASEFILEDS.HTMAIN["AC_NM"].ToString();
            ...
            chkcust_active.Checked = objBASEFILEDS.HTMAIN["isdeactive"] != null && objBASEFILEDS.HTMAIN["isdeactive"].ToString() != "" ? bool.Parse(objBASEFILEDS.HTMAIN["isdeactive"].ToString()) : false;
        ...
        private bool Click_Save()
        {
            ...
            if (txtCustNm.Text == "") { AutoClosingMessageBox.Show("Please enter valid Customer", "Validation", 3000); flg = false; }
            else if (txtAdd1.Text == "") { AutoClosingMessageBox.Show("Please enter Address1", "Validation", 3000); flg = false; }
            return flg;
        }
        ...
        private void frmCustomerMast_Enter(object sender, EventArgs e)
        {
        ...
        private void frmCustomerMast_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (((frm_mainmenu)this.MdiParent).ActiveMdiChild != null)
            {
        ...
        private void frmCustomerMast_Resize(object sender, EventArgs e)
        {
        ...
        private void txtCustNm_Validating(object sender, CancelEventArgs e)
        {
            if (objBASEFILEDS.Tran_mode != "view_mode")
            {
                if (txtCustNm.Text == "")
                {
                    AutoClosingMessageBox.Show("Please enter valid Customer", "Validation", 3000);
                    e.Cancel = true;
                }
                else
                {
                    DataSet ds = objDBAdaper.dsquery("select Ac_id,AC_NM from " + objBASEFILEDS.Main_tbl_nm + " where AC_NM ='" + txtCustNm.Text.Replace("'", "''") + "' and Ac_id!='" + objBASEFILEDS.Tran_id + "' and compid='" + objBASEFILEDS.ObjCompany.Compid + "'");
                    if (ds != null && ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                    {
                        AutoClosingMessageBox.Show("Customer already exists", "Validation", 3000);
                        e.Cancel = true;
                    }
                    if (txtDispNm.Text == "")
                    {
                        txtDispNm.Text = txtCustNm.Text;
                    }
                }
            }
        }
        private void txtAdd1_Validating(object sender, CancelEventArgs e)
        {
            if (objBASEFILEDS.Tran_mode != "view_mode")
            {
                if (txtAdd1.Text == "")
                {
                    AutoClosingMessageBox.Show("Please enter Address1", "Validation", 3000);
                    e.Cancel = true;
                }
            }
        }

        private void chkcust_active_CheckedChanged(object sender, EventArgs e)
        {
            if (chkcust_active.Checked)
            {
        ...
        private void txtGroup_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                frmPopup objpopup = new frmPopup(objBASEFILEDS.HTMAIN, "IVW_CUSTOMERGRP", "", "ac_grp_id,ac_grp_nm", "ac_grp_nm;Account Group", "Please Select", "", false, "", "0");
                objpopup.ObjBFD = objBASEFILEDS;
                objpopup.ShowDialog();
                txtGroup.Text = objBASEFILEDS.HTMAIN["ac_grp_nm"].ToString();
            }
